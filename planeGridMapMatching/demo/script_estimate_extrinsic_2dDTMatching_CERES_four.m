...
if ~exist('tools_matlab')
    tools_matlab = '/home/bingo/ethan/OGDT_multi_lidar_calibration/tools/matlab';
end
...
if ~exist('figure_title')
  figure_title = 'calib before';
end
vis_calibrated_concate_points_leveling_four;

clear('calib_after_path');
calib_after_path = 'planeGridMatch_leveling_calib_final';

clear('figure_title')
figure_title = 'calib after';
