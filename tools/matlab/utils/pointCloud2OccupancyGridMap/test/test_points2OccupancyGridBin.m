...
occupancyGridBin = points2OccupancyGridBin(points2OccupancyGridParams, input_point_cloud);

occupancyGridBin_R = imcomplement(occupancyGridBin);

figure();
pcshow(pointCloud(input_point_cloud));

figure();
imshow(occupancyGridBin_R);
