...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        doubleSpinBox_set_x->setMinimum(-10);
        doubleSpinBox_set_x->setMaximum(10);
        doubleSpinBox_set_x->setSingleStep(0.1);
        doubleSpinBox_set_x->setDecimals(4);
        ...
        doubleSpinBox_set_y->setMinimum(-10);
        doubleSpinBox_set_y->setMaximum(10);
        doubleSpinBox_set_y->setSingleStep(0.1);
        doubleSpinBox_set_y->setDecimals(4);
        ...
        doubleSpinBox_set_z->setMinimum(-10);
        doubleSpinBox_set_z->setMaximum(10);
        doubleSpinBox_set_z->setSingleStep(0.1);
        doubleSpinBox_set_z->setValue(2);
        doubleSpinBox_set_z->setDecimals(4);
        ...
        doubleSpinBox_set_roll->setSingleStep(0.1);
        doubleSpinBox_set_roll->setDecimals(4);
        ...
        doubleSpinBox_set_pitch->setSingleStep(0.1);
        doubleSpinBox_set_pitch->setDecimals(4);
        ...
        doubleSpinBox_set_yaw->setSingleStep(0.1);
        doubleSpinBox_set_yaw->setDecimals(4);
