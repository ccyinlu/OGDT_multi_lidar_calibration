...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle n("~");
    std::string dataset_folder, sequence_number, output_bag_file, lidar_topic;
    ...
    ros::Publisher pub_laser_cloud = n.advertise<sensor_msgs::PointCloud2>(lidar_topic, 2);
    ...
    while (std::getline(timestamp_file, line) && ros::ok())
    {
        ...
        if (to_bag)
        {
            ...
            bag_out.write(lidar_topic, ros::Time::now(), laser_cloud_msg);
